"""
Implementations of progressive neural networks.
"""
import time
import numpy as np
...
class ProgressiveMultitaskRegressor(KerasModel):
  ...
  This architecture was introduced in the following paper:

  Rusu, Andrei A., et al. "Progressive neural networks." arXiv preprint arXiv:1606.04671 (2016).

  Progressive networks allow for multitask learning where each
  task gets a new column of weights. As a result, there is no
  exponential forgetting where previous tasks are ignored.
  """
